...
from ...models.vector_sources_upload_create_body import VectorSourcesUploadCreateBody
...
def _get_kwargs(
    slug: str,
    *,
    body: VectorSourcesUploadCreateBody,
) -> Dict[str, Any]:
    headers: Dict[str, Any] = {}

    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": f"/api/v1/vector-sources/{slug}/upload/",
    }
