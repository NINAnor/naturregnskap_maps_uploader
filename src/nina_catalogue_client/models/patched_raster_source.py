...
T = TypeVar("T", bound="PatchedRasterSource")


@_attrs_define
class PatchedRasterSource:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        patched_raster_source.additional_properties = d
        return patched_raster_source
