...
T = TypeVar("T", bound="PaginatedRasterSourceList")


@_attrs_define
class PaginatedRasterSourceList:
    """
    Attributes:
        count (int):  Example: 123.
        results (List['RasterSource']):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RasterSource.from_dict(results_item_data)
        ...
        paginated_raster_source_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_raster_source_list.additional_properties = d
        return paginated_raster_source_list
