...
T = TypeVar("T", bound="PaginatedVectorSourceList")


@_attrs_define
class PaginatedVectorSourceList:
    """
    Attributes:
        count (int):  Example: 123.
        results (List['VectorSource']):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = VectorSource.from_dict(results_item_data)
        ...
        paginated_vector_source_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_vector_source_list.additional_properties = d
        return paginated_vector_source_list
