...
T = TypeVar("T", bound="PaginatedLayerList")


@_attrs_define
class PaginatedLayerList:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Layer.from_dict(results_item_data)
        ...
        paginated_layer_list.additional_properties = d
        return paginated_layer_list
