...
T = TypeVar("T", bound="PaginatedLayerGroupList")


@_attrs_define
class PaginatedLayerGroupList:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = LayerGroup.from_dict(results_item_data)
        ...
        paginated_layer_group_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_layer_group_list.additional_properties = d
        return paginated_layer_group_list
